...
- **Core Simulation & Determinism:** Pure C# .NET 8 simulation, deterministic clock, PCG32 RNG implementation (เชื่อมเข้ากับ `CaseGenerator` แล้ว), strongly typed IDs, Entity/Location topology, immutable WorldEvent stream, atomic MoveEntity, deterministic JSONL event logger, 263/263 xUnit automated tests.
...
- [x] Automated tests ผ่าน (263/263 tests passed)
...
8. **Engineering Gate (ผ่านระดับ local/CI):** build 0 warning, tests 263/263 และ headless smoke ไทย/อังกฤษผ่าน; เหลือตรวจ Windows export artifact บนเครื่องแจก build จริง.
