...
- **ตัวตนของตัวละคร (Milestone 7):** ผู้เล่นตั้งชื่อตัวเองได้ก่อนเข้ากะ — ข้อความ 52 จุดที่เคยเขียนว่า "George" ตายตัว เปลี่ยนเป็นตัวแทนที่เติมชื่อตอนแสดงผล และแก้สรรพนามที่เคยสมมติเพศของตัวละครที่ผู้เล่นยังไม่ได้บอก; NPC มีใบหน้าที่วาดด้วยโค้ดจาก id ของตัวเอง (รูปหน้า ทรงผม แว่น ปกเสื้อ ไหล่) คนเดิมได้หน้าเดิมเสมอโดยไม่ต้องใช้ไฟล์ภาพ; ชื่อ/อาชีพ/ตำแหน่งประจำ ย้ายจาก switch ในโค้ดไปอยู่ในไฟล์เนื้อหาครบสองภาษา และแสดงใต้รูปทุกครั้งที่คุยกับใครสักคน.
- **คืนไม่ซ้ำเดิม:** `NightShiftDirector` เดิมเป็นเหตุการณ์ 10 อย่างตายตัว เวลาตายตัว ทั้ง 15 คืนที่วัดมาจึงเหมือนกันหมด รวมถึงช่วงเงียบ 43 นาทีที่ตกที่เดิมทุกคืน; ตอนนี้ seed เลือกว่าจะเกิดอะไร กับใคร ที่ไหน เมื่อไร จากคลัง 12 เหตุการณ์ โดยมีเทสต์คุมสิ่งที่ห้ามแปรผัน (ทุกเหตุการณ์อยู่ในกะ, คำเตือนรุ่งเช้าอยู่ท้ายสุด, ไม่มีช่วงเงียบเกิน 90 นาที).
- **บทพูดและ UX:** เขียนบทพูดใหม่ทั้งหกคนให้มีน้ำเสียงต่างกันจริงทั้งสองภาษา; ชื่อห้องมีสองแบบ (บนแผนผัง กับ ในประโยค); แถบข้างในหน้าต่าง ๆ เปลี่ยนจากเงานิรนามเป็นสถานะของคืน (เวลาที่เหลือ/ชื่อคุณ/เบาะแส/คำให้การ/คนอื่นมองคุณยังไง); แผงข้างบอกชื่อและอาชีพของทุกคนในห้องแทนการนับหัว; และตัวเลขบนปุ่ม (1, 2, 5) ซึ่งเคยเป็นคีย์ลัดที่ไม่เคยผูกกับปุ่มจริง ตอนนี้กดได้จริงทั้ง 1–5 และ Esc.
...
7. **Milestone 7 — Presentation Polish (ทำไปแล้วส่วนหนึ่ง):** ผู้เล่นตั้งชื่อตัวเองได้, NPC มีใบหน้าแบบ procedural พร้อมชื่อ/อาชีพ/ตำแหน่งประจำครบสองภาษา, บทพูดเขียนใหม่ให้แต่ละคนมีน้ำเสียงของตัวเอง, เหตุการณ์ในคืนสุ่มตาม seed และผังแผง/UX ปรับใหม่; **ยังเหลือ** room art, sprite animation, anomaly effects และ audio ซึ่งควรทำหลัง gameplay ผ่านเกณฑ์ playtest.
...
- [x] ให้ความลับถูกจับได้หลายครั้ง บังคับขั้นต่ำ 2 คนต่อคืน และเปิดทางให้ข่าวลือถึงผู้เล่นได้
- [ ] จัดฉากความลับในที่ที่มีคนผ่าน — คืนหนึ่งเกิด 8 ครั้ง แต่ไม่มีใครเห็นเลย
...
- [x] ให้ผู้เล่นตั้งชื่อตัวเอง และให้ NPC มีใบหน้า/ชื่อ/อาชีพ/ตำแหน่งชัดเจน
- [x] สุ่มเหตุการณ์ในแต่ละคืนตาม seed แทนตารางตายตัว
- [x] เขียนบทพูดใหม่ให้แต่ละคนมีน้ำเสียงของตัวเอง และปรับภาษาไทยให้เป็นธรรมชาติ
- [ ] นำ room art, sprite animation และ audio กลับแบบวัดประสิทธิภาพทีละระบบ
